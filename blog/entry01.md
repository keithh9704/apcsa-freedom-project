...
### Skills 
I learned to enchance my consideration and how to learn skills.
#### Consideration
Although I found a tool like godot that perfectly fits with my interest, I didn't stop there and considered another tool like gdevelop to test out. Eventaully when testing both of them out, I actually liked gdevelop more than godot. If I didn't give myself a chance to tinker with gdevelop then I wouldn't have found the perfect tool for me.
#### How to learn
Jumping between godot to gdevelop, I looked up many youtube videos explaining the basics of both tools. Instead of just watching the video and try to "learn" from there, I go step by step with the video and finding out how this software works.
### Next Steps
Now finalizing my tool I absolute want to commit to. I am excited on the things I can learn while using this tool as I go into the second stage of EDP, researching the problem.
