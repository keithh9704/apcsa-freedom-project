...
### Content
After the Christmas break, I worked on my tool and caught up on the general basics of GDevelop and learned mostly on the different actions you can do on the event tabs. I learned how to traverse through different animations if the player got caught by an enemy or fell off the map.
...
### Skills
For the skills I learned during this time period, I enhanced my attention to detail and logical reasoning.
#### Attention to detail
...
#### Logical Reasoning
More than half of Gdevelop's function relies on the events tab and while looking at this for a couple of months I haven't fully dived in this part of Gdevelop. This section of learning my tool showed me the different ways to use the "if... then..." format. Such as changing animations, deactivating certain behaviors and even changing scenes with an easy click of a button.
### Next Steps
We are starting our MVP soon and I am pretty excited to code out what I want to do for this year's MVP. Although senioritis is starting to kick in for me, I want to finish strong and at least get out an MVP that I would be proud of.
